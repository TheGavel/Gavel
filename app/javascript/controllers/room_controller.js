          ...
          thisController.asyncForEach(
            ...
            async (user) => {
              ...
              let imgHtml = `<div class="relative">
                          ...
                          <div class="bottom-0" style="clip-path: polygon(25% 0%, 100% 0%, 75% 100%, 0% 100%);background-color: rgb(252 211 77); padding: 0 1.25rem; text-align:center; ">${user_bid}</div>
                          </div>`;
        ...
        if (message != undefined) {
          (async () => {
            ...
            let messageHtml = `<div class="m-2">
              ...
              &nbsp&nbsp
              <span class="p-4 rounded-2xl text-white font-bold bg-blue-500 opacity-90 text-lg"> ${message} </span>
            </div>`;
