...
var FileUploadWithPreview = /*#__PURE__*/function () {
  ...
  function FileUploadWithPreview(uploadId) {
    ...
    var el = $(".custom-file-container")[0];
    if (!el) {
...
// console.log($('#product_images'));
    // $('#product_images').attr("id","file-upload-with-preview-"+uploadId)
    // console.log($(".file-upload-with-preview-"+uploadId));
    // console.log(inputx);
    // $("#file-upload-with-preview-"+uploadId).attr("aria-label","Choose File");
    // $("#file-upload-with-preview-"+uploadId).attr("class","input-hidden");
    // $("#file-upload-with-preview-"+uploadId).insertBefore($('.input-visible')  );

    $('#product_images').attr("aria-label","Choose File");
    $('#product_images').attr("class","input-hidden");
    $('#product_images').insertBefore($('.input-visible')  );
    ...
    // document.querySelector(".input-container").insertAfter()
    // document.querySelector(".input-visible").before(inputx);
    // document.querySelector(".input-container").insertBefore(inputx, document.querySelector(".input-visible"));
