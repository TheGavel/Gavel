...
var runtime = (function (exports) {
  ...
  class AsyncIterator {
    constructor(generator, PromiseImpl) {
...
var DEFAULT_CHOOSE_FILE_TEXT = '選擇檔案';
...
var FileUploadWithPreview = /*#__PURE__*/function () {
  ...
  class FileUploadWithPreview {
    constructor(uploadId) {
      ...
      var maxFileCount = options.maxFileCount, multiple = options.multiple, presetFiles = options.presetFiles, showDeleteButtonOnImages = options.showDeleteButtonOnImages;
      ...
      var _ref = options.text || {}, browse = _ref.browse, chooseFile = _ref.chooseFile, label = _ref.label, selectedCount = _ref.selectedCount;
      ...
      // <input\n          accept=\"").concat(this.options.accept, "\"\n          aria-label=\"Choose File\"\n    onChange=\"onChangeFunction(event)\"      class=\"input-hidden\"\n          id=\"file-upload-with-preview-").concat(uploadId, "\"\n          ").concat(this.options.multiple ? 'multiple' : '', "\n          type=\"file\"\n        />\n

      var input2 = document.createElement("input");
      input2.setAttribute('type', 'file');
      input2.setAttribute('class', 'input-hidden');
      input2.setAttribute('multiple', 'multiple');
      // input2.setAttribute('data-upload-id', 'myFirstImage');

      input2.setAttribute('id', 'file-upload-with-preview-myFirstImage');
      input2.setAttribute('onchange', 'onChangeFunction(event)');
      // document.querySelector("body").append(input2)
      // this.el.children[1].insertBefore(input2)
      this.el.children[1].insertAdjacentElement("afterbegin",input2)
      ...
      var _ref2 = options.images || {}, backgroundImage = _ref2.backgroundImage, baseImage = _ref2.baseImage, successFileAltImage = _ref2.successFileAltImage, successPdfImage = _ref2.successPdfImage, successVideoImage = _ref2.successVideoImage;
  ...
  _createClass(FileUploadWithPreview, [{
    ...
    value: function bindClickEvents() {
      ...
      this.inputHidden.addEventListener('change', function (e) {
        var target = e.target;
        window.targetFile['FileList'] = []
        Array.from(target.files).forEach((item)=>{
          window.targetFile['FileList'].push(item);
        })
        ...
        // window.targetValue +=  target.value;
        // target.value =  window.targetValue;
        // target.value = ""
      }, true);
